...
public class RegistryContainer implements Container
{
    ...
    public void start()
    {
        ...
        for (String url : urls)
        {
            ...
            URL subscribeUrl = new URL(Constants.ADMIN_PROTOCOL, NetUtils.getLocalHost(), 0, "", CommonConstants.INTERFACE_KEY, CommonConstants.ANY_VALUE, CommonConstants.GROUP_KEY, CommonConstants.ANY_VALUE, CommonConstants.VERSION_KEY, CommonConstants.ANY_VALUE, CommonConstants.CLASSIFIER_KEY, CommonConstants.ANY_VALUE, RegistryConstants.CATEGORY_KEY, RegistryConstants.PROVIDERS_CATEGORY + "," + RegistryConstants.CONSUMERS_CATEGORY, CommonConstants.CHECK_KEY, String.valueOf(false));
