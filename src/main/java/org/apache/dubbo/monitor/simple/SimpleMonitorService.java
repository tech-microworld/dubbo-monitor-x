...
public class SimpleMonitorService implements MonitorService {
    ...
    private void write() throws Exception {
        ...
        // fixme System out 为测试代码，正式上线前，请移除。
        System.out.println(" write stat log statistics，address :" + statistics.getAddress() + ",timestamp:" + System.currentTimeMillis() + ", date now : " + new Date() + ", service : " + statistics.getServiceInterface());
        logger.info(" write stat log statistics，address :" + statistics.getAddress() + ",timestamp:" + System.currentTimeMillis() + ", date now : " + new Date() + ", service : " + statistics.getServiceInterface());
